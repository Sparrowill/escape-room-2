...
import {smoking_entrance} from "./smoking.js";
...
export function create_puzzles(){
    ...
    armoury_guns.set_explanation("As you look at the wall of guns, you see a small plaque set into the bottom of the frame. It reads: <br><br> This collection of antique weapons was curated by the gamekeeper. He was known to entertain children by leaving hidden messages around the grounds, using the framed guns as a cipher.");
    ...
    smoking_exit.set_success_text("Correct! Now you just need to come out of this puzzle, and leave the game!",function (){
        smoking_entrance.add_nav_btn("to-end","60","30",move,"smoking-end");
        //Reload
