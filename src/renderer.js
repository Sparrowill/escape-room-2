...
fg.appendChild(create_text_element("p","<ul><li>The object of the game is to reach the exit as quickly as possible You reach the exit by solving puzzles and advancing through to new rooms.</li><br><li>Throughout the game you will (hopefully) collect clues and keys by looking around -clicking on stuff- and solving puzzles. Each clue/key is only used once.</li><br><li>You 'move' through the rooms by clicking on yellow circles (they're the same as in Escape the Prison). You can't miss them!</li><br><li>Some of the puzzles can be quite devious. You may want a pen and paper to keep track of things. If you get stuck at any point, each puzzle has hints available.</li><br><li>Some of the puzzles rely on audio. Make sure your device is able to play audio before you start the room.</li><br><li> As with my other room, there is no time limit. Just try to escape. I set my 'target' time while developing the game at one hour, to give you an idea.</li></ul>",false))
