...
fg.appendChild(create_text_element("p","Welcome to Escape the Mansion. This virtual escape room is a standalone 'one-shot' experience and does not relate at all to my previous 'Escape the Prison' room. However, the puzzles ae designed to be more challenging in this room, so why not try the other one first?",true));
fg.appendChild(create_text_element("h2","Rules and Instructions",true));
fg.appendChild(create_text_element("p","<ul><li>The object of the room is to reach the exit as quickly as possible You reach the exit by solving consecutive puzzles and advancing through to new rooms.</li><li>Throughout the room you will (hopefully) collect clues and keys by looking aroud - clicking on stuff- and solving puzzles. Each clue/key is only used once.</li><li>You 'move' through the rooms by clicking on yellow circles (they're the same as in Escape the Prison). You can't miss them!</li><li>Some of the puzzles can be quite devious. You may want a pen and paper to keep track of things. If you get stuck at any point, each puzzle has hints available.</li><li>Some of the puzzles rely on audio. Make sure your device is able to play audio before you start the room.</li><li> As with my other room, there is no time limit. Just try to escape. I set my 'target' time while developing the game at one hour, to give you an idea.</li></ul>",false))
